...
|------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Noun-adjunct           | Noun-adjuncts are compound-words; typically groups of two-or-more words separated by a dash. Some compound-words start with a noun-adjunct, which are defined as a noun acting (i.e., being used as) as an adjective. For example, in the word employee-name, 'employee' is a noun-adjunct and 'name' is a noun (or, more specifically, a head-noun). |
